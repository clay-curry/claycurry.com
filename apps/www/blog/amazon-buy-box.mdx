...
title: How the Amazon Buy Box Recommends Billions of Offers per Day
subtitle: A simplified system-design view of the marketplace slot that decides which seller gets seen first
prefix: The Buy Box is Amazon's highest-leverage offer-ranking surface. To populate it, Amazon has to filter, score, and guardrail competing offers at enormous scale.
tags:
  - Systems Design
  - E-Commerce
  - Marketplaces

...
>
> This article (and this warning message) was generated using AI and has not been thoroughly fact-checked. The technical details, code examples, and explanations may contain inaccuracies or errors. Do not rely on this content for production use or critical decision-making without independent verification.
...
The output is static HTML and CSS — no client-side JavaScript is involved in displaying math.
</Summary>

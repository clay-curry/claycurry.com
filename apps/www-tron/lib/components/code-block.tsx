...
export const CodeBlock = ({
  ...
  if (!displayTitle) {
    return (
      <div className="relative my-6">
        <CodeBlockComponent className="rounded-sm" />
        <Button
  ...
  return (
    <Card className="not-prose mb-6 gap-0 overflow-hidden rounded-sm p-0 shadow-none">
      <CardHeader className="flex flex-row items-center gap-2 border-b bg-sidebar py-1.5 pr-1.5 text-muted-foreground">

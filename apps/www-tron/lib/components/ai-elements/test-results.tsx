  ...
  return (
    <div className={cn("flex items-center gap-3", className)} {...props}>
      {children ?? (
        <>
          <Badge
            className="gap-1 bg-green-900/30 text-green-400"
            variant="secondary"
          >
          ...
          {summary.failed > 0 && (
            <Badge
              className="gap-1 bg-red-900/30 text-red-400"
              variant="secondary"
            >
          ...
          {summary.skipped > 0 && (
            <Badge
              className="gap-1 bg-yellow-900/30 text-yellow-400"
              variant="secondary"
            >
...
export const TestError = ({
  ...
  <div
    className={cn(
      "mt-2 rounded-md bg-red-900/20 p-3",
      className
    )}
    {...props}
  >
...
export const TestErrorMessage = ({
  ...
  <p
    className={cn(
      "font-medium text-red-400 text-sm",
      className
    )}
    {...props}
  >
...
export const TestErrorStack = ({
  ...
  <pre
    className={cn(
      "mt-2 overflow-auto font-mono text-red-400 text-xs",
      className
    )}
    {...props}
  >

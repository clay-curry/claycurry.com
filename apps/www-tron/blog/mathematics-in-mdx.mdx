...
title: Embedding LaTeX in MDX
shortTitle: Math in MDX + Next.js
subtitle: Developer's Guide to Technical and Scientific Typography in MDX
...
<Summary>
[LaTeX](https://www.latex-project.org/) is the de facto markup language for the expression and communication 
of technical and scientific ideas. It is available as free software. Markdown is a lightweight markup language used

...
published: false
date: "15 Jan 2026"
title: Distributing Math over the Web
subtitle: A guide to rendering LaTeX in MDX with Next.js
...
# Distributing Math over the Web

<Summary>

Rendering mathematics on the web requires explicit tooling. This guide explores the unified plugin ecosystem for processing LaTeX in MDX, compares output formats and rendering engines, and recommends a stack for Next.js applications focused on build-time performance.

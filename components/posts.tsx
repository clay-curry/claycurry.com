...
export function Posts({
    ...
    {filterEntries && (
      ...
      <div 
        className="grid gap-7 grid-cols-1 md:grid-cols-[repeat(auto-fill,minmax(400px,1fr))]"
      >
        {
          entries
            .filter(post => {
...
function PostEntry(
    { slug, date, title, subtitle, prefix, tags }:
    {
      slug: string,
      date: string,
      title: string,
    ...
    return <div className="group h-full w-full cursor-pointer rounded-sm">
      <Link 
        className={

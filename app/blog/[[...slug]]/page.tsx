...
export default async function BlogSlugPage({
    ...
    if (!Array.isArray(slug) || slug.length === 0) {
        ...
        const { default: BlogArticle } = await import(`@/app/blog/${slug}.mdx`)
                    ...
                    <aside className="sticky top-40 hidden max-h-[calc(100vh-10rem)] w-72 md:block">
                        <div className="flex max-h-[calc(100vh-10rem)] flex-col gap-4 transition-all duration-300">
                            ...
                            <nav className="flex min-h-0 flex-1 flex-col">
                                <span className="block pb-2 font-semibold">
                                    Table of Contents</span><ul className="scrollbar overflow-y-auto">
                            ...
                            <div className="w-full">
                                ...
                                <div className="flex gap-4">
                                    <a href="https://x.com/intent/tweet?text=%22My%20Workout%20Routine%22%20by%20%40maxrohowsky&amp;url=https%3A%2F%2Fmaxrohowsky.com%2Fblog%2Fworkout-routine" target="_blank" rel="noopener noreferrer" className="hover:opacity-80" aria-label="Share on X (Twitter)">
                                        <svg
                                            aria-hidden="true"
                                            focusable="false"
                                            data-prefix="fab"

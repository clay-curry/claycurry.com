      ...
      <section className="hero-section flex flex-col items-start justify-center px-4">
        <div className="text-left pl-4 space-y-4 animate-fade-in-left min-h-[50vh] pt-24">
          ...
          <p className="mt-12 max-w-2xl text-lg text-gray-700 dark:text-gray-200 leading-relaxed">
            Comorade in the digital realm; horticulturalist for software ecosystems. 
          </p>
        </div>
        ...
        >
          ...
          <p className="text-gray-800 dark:text-gray-200 mb-2">
            My career centers on AI-driven applications across defense and e-commerce:
          </p>
          <ol className="space-y-2 list-decimal ml-6 text-gray-700 dark:text-gray-300">
            <li>
              <span className="font-semibold">Amazon.com:</span> Core Shopping (Homepage, Detail Page, OffersX). Software Dev Engineer.
            </li>
            <li>
              <span className="font-semibold">Oklahoma Aerospace and Defense Institute:</span> US Air Force. Lab Assist - Computer Vision .
            </li>
            <li>
              <span className="font-semibold">Oklahoma University:</span> Department of Physics & Astronomy. Linux System Admin.
            </li>
          </ol>
        </div>
        <div
        ...
        >
          ...
          <ol className="space-y-2 list-decimal ml-6 text-gray-700 dark:text-gray-300">
            <li>
              <span className="font-semibold">TODO:</span> implement activity monitor
            </li>
          </ol>
        </div>
        </section>

...
export default function HomePage() {
  return (
    <section className="hero-section flex flex-col items-start justify-center px-4">
      ...
      <div
        className="w-full max-w-3xl mt-12 p-6 rounded-xl bg-white dark:bg-zinc-900 shadow-md border border-gray-100 dark:border-zinc-800 opacity-0 transition-opacity duration-700"
        style={{
      ...
      <div
        className="w-full max-w-3xl mt-8 p-6 rounded-xl bg-white dark:bg-zinc-900 shadow-md border border-gray-100 dark:border-zinc-800 opacity-0 transition-opacity duration-700"
        style={{
          animation: "fadeInEffect 0.5s forwards",
          animationDelay: ".4s",
        }}
      >
        ...
        <div>
          <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100">
            University of Oklahoma — Linux System Administrator
          </h3>
          <p className="text-gray-600 dark:text-gray-400 italic">
      ...
      {/* Certifications */}
      <div
        className="w-full max-w-3xl mt-8 mb-16 p-6 rounded-xl bg-white dark:bg-zinc-900 shadow-md border border-gray-100 dark:border-zinc-800 opacity-0 transition-opacity duration-700"
        style={{
          animation: "fadeInEffect 0.5s forwards",
          animationDelay: ".8s",
        }}

export const description = 'Tailwind CSS best practices, tips, and coding style that I always use.'
export const lang = 'en'
export const date = '2023-02-06'
export const category = 'tailwindcss'
export const caption = 'Best Practices'
export const tags = ['tailwindcss', 'best-practices']
export const title = 'Tailwind CSS Best Practices'

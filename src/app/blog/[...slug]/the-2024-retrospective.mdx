...
export const date= '2024-02-25'
export const title= 'Programming Abstractions for LLMs'
export const description=  'How programming language design will address the rise of indie developers, the limitations of large language models, and the vulnerabilities of front-end cloud. '
export const tags = ['endofyear', '']

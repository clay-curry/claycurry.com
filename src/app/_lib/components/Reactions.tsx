...
import { ContentType, incrementReaction, ReactionType } from '../db/actions';
import clsx from 'clsx';
import { m, useAnimationControls } from 'framer-motion';
import { useRouter } from 'next/router';
import { useEffect } from 'react';

import EmojiReaction from '@/app/_lib/components/EmojiReaction';
import InsightButton from '@/app/_lib/components/InsightButton';
import ShareButton from '@/app/_lib/components/ShareButton';

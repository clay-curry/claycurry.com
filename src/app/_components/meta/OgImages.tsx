...
import { formatLang } from '@/app/_helpers/post';

import type { TPageOgImage, TPostOgImage } from '@/app/_utils/types';
    ...
    <div style={styles.container}>
      ...
      <div style={styles.author}>
        <img
          width="48"
          height="48"
          src="https://github.com/clay-curry.png?size=48"
          style={styles.authorAvatar}
        />
        <div style={styles.authorName}>@clay-curry</div>

...
import ActionCenter from '@/app/(site)/ActionCenter';
import Activity from '@/app/(site)/Activity';
import { XIcon } from '@/app/(site)/Icons';
import NewPosts from '@/app/(site)/NewPosts';
import TipShortcuts from '@/app/(site)/TipShortcuts';

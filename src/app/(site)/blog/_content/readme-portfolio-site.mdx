...
This portfolio website is built with **Next.js 16**, **Tailwind CSS**, and **MDX** for content authoring. It serves as both a professional showcase and a playground for experimenting with modern web technologies.

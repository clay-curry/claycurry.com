...
- **Redis** (`lib/effect/services/redis.ts`): View counts and click tracking with environment-prefixed keys (`prod:`, `preview:`, `dev:`). Requires `KV_REST_API_REDIS_URL` (auto-set by dev container).
